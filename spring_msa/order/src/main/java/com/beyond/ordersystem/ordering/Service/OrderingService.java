...
//                product.updateStockQuantity(quantity);
                ...
                httpHeaders.setContentType(MediaType.APPLICATION_JSON); // axios는 별도로 세팅하지 않는 경우 APPLICATION_JSON로 나가지만 얘는 따로 설정해줘야 함
